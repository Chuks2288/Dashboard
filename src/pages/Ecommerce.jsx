    ...
    return (
        <div className='mt-12'>
            <div className="flex flex-wrap lg:flex-nowrap justify-center">
                ...
                m-3 bg-hero-pattern bg-cover bg-no-repeat bg-center">
                    ...
                    justify-center gap-1 items-center">
                        {earningData.map((item) => (
                            <div
                                ...
                                dark:bg-secondary-dark-bg md:w-30 p-4 pt-9 rounded-2xl"
                            >
                                <button type='button'
                        ...
                        <div className="border-r-1 border-color m-4 pr-10">
                            <div className="">
                                <p>
                                    ...
                                    cursor-pointer text-white bg-green-400 ml-3
                                    text-xs rounded-full'>23%</span>
                                </p>
